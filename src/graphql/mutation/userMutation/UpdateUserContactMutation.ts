...
export function useUpdateUserContactMutation<TData = any>(fragment: DocumentNode, options?: MutationHookOptions<{ updateUserContactMutation: TData }, UpdateUserContactMutationVars>) {
    return useMutation<{ updateUserContactMutation: TData }, UpdateUserContactMutationVars>(UpdateUserContactMutation(fragment), options);
}

export function UpdateUserContactMutation(fragment: DocumentNode): DocumentNode {
    return gql`
