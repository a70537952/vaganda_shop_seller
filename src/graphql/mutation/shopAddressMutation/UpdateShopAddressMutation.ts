...
export function useUpdateShopAddressMutation<TData = any>(fragment: DocumentNode, options?: MutationHookOptions<{ updateShopAddressMutation: TData }, UpdateShopAddressMutationVars>) {
    return useMutation<{ updateShopAddressMutation: TData }, UpdateShopAddressMutationVars>(UpdateShopAddressMutation(fragment), options);
}

export function UpdateShopAddressMutation(fragment: DocumentNode): DocumentNode {
    return gql`
