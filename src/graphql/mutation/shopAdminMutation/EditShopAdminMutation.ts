...
export function useEditShopAdminMutation<TData = any>(fragment: DocumentNode, options?: MutationHookOptions<{ editShopAdminMutation: TData }, EditShopAdminMutationVars>) {
    return useMutation<{ editShopAdminMutation: TData }, EditShopAdminMutationVars>(EditShopAdminMutation(fragment), options);
}
