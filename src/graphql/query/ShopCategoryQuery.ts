...
export function useShopCategoryLazyQuery<TData = any>(fragment: DocumentNode, options?: QueryHookOptions<{ shopCategory: TData[] }, ShopCategoryVars>
) {
    return useLazyQuery<{shopCategory: TData[]}, ShopCategoryVars>(shopCategoryQuery(fragment), options);
}

export function useShopCategoryQuery<TData = any>(fragment: DocumentNode, options?: QueryHookOptions<{shopCategory: TData[]}, ShopCategoryVars>) {
    return useQuery<{shopCategory: TData[]}, ShopCategoryVars>(shopCategoryQuery(fragment), options);
}
