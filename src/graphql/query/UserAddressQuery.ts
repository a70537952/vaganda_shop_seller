...
export function useUserAddressLazyQuery<TData = any>(fragment: DocumentNode, options?: QueryHookOptions<{ userAddress: WithPagination<TData> }, UserAddressVars>
) {
    return useLazyQuery<{userAddress: WithPagination<TData>}, UserAddressVars>(userAddressQuery(fragment), options);
}

export function useUserAddressQuery<TData = any>(fragment: DocumentNode, options?: QueryHookOptions<{userAddress: WithPagination<TData>}, UserAddressVars>) {
    return useQuery<{userAddress: WithPagination<TData>}, UserAddressVars>(userAddressQuery(fragment), options);
}
