...
export function useProductLazyQuery<TData = any>(fragment: DocumentNode, options?: QueryHookOptions<{ product: WithPagination<TData> }, ProductVars>
) {
    return useLazyQuery<{product: WithPagination<TData>}, ProductVars>(productQuery(fragment), options);
}

export function useProductQuery<TData = any>(fragment: DocumentNode, options?: QueryHookOptions<{product: WithPagination<TData>}, ProductVars>) {
    return useQuery<{product: WithPagination<TData>}, ProductVars>(productQuery(fragment), options);
}
