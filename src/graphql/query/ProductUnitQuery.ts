...
export function useProductUnitLazyQuery<TData = any>(fragment: DocumentNode, options?: QueryHookOptions<{ productUnit: TData[] }, ProductUnitVars>
) {
    return useLazyQuery<{productUnit: TData[]}, ProductUnitVars>(productUnitQuery(fragment), options);
}

export function useProductUnitQuery<TData = any>(fragment: DocumentNode, options?: QueryHookOptions<{productUnit: TData[]}, ProductUnitVars>) {
    return useQuery<{productUnit: TData[]}, ProductUnitVars>(productUnitQuery(fragment), options);
}
