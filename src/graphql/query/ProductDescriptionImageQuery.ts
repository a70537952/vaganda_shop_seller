...
export function useProductDescriptionImageLazyQuery<TData = any>(fragment: DocumentNode, options?: QueryHookOptions<{ productDescriptionImage: TData[] }, ProductDescriptionImageVars>
) {
    return useLazyQuery<{productDescriptionImage: TData[]}, ProductDescriptionImageVars>(productDescriptionImageQuery(fragment), options);
}

export function useProductDescriptionImageQuery<TData = any>(fragment: DocumentNode, options?: QueryHookOptions<{productDescriptionImage: TData[]}, ProductDescriptionImageVars>) {
    return useQuery<{productDescriptionImage: TData[]}, ProductDescriptionImageVars>(productDescriptionImageQuery(fragment), options);
}
