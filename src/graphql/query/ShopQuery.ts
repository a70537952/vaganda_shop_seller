...
export function useShopLazyQuery<TData = any>(fragment: DocumentNode, options?: QueryHookOptions<{ shop: WithPagination<TData> }, ShopVars>
) {
    return useLazyQuery<{shop: WithPagination<TData>}, ShopVars>(shopQuery(fragment), options);
}

export function useShopQuery<TData = any>(fragment: DocumentNode, options?: QueryHookOptions<{shop: WithPagination<TData>}, ShopVars>) {
    return useQuery<{shop: WithPagination<TData>}, ShopVars>(shopQuery(fragment), options);
}
