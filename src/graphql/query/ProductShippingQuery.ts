...
export function useProductShippingLazyQuery<TData = any>(fragment: DocumentNode, options?: QueryHookOptions<{ productShipping: WithPagination<TData> }, ProductShippingVars>
) {
    return useLazyQuery<{productShipping: WithPagination<TData>}, ProductShippingVars>(productShippingQuery(fragment), options);
}

export function useProductShippingQuery<TData = any>(fragment: DocumentNode, options?: QueryHookOptions<{productShipping: WithPagination<TData>}, ProductShippingVars>) {
    return useQuery<{productShipping: WithPagination<TData>}, ProductShippingVars>(productShippingQuery(fragment), options);
}
