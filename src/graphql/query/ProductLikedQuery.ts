...
export function useProductLikedLazyQuery<TData = any>(fragment: DocumentNode, options?: QueryHookOptions<{ productLiked: WithPagination<TData> }, ProductLikedVars>
) {
    return useLazyQuery<{productLiked: WithPagination<TData>}, ProductLikedVars>(productLikedQuery(fragment), options);
}

export function useProductLikedQuery<TData = any>(fragment: DocumentNode, options?: QueryHookOptions<{productLiked: WithPagination<TData>}, ProductLikedVars>) {
    return useQuery<{productLiked: WithPagination<TData>}, ProductLikedVars>(productLikedQuery(fragment), options);
}
