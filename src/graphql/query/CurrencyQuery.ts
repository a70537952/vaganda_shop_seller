...
export function useCurrencyLazyQuery<TData = any>(fragment: DocumentNode, options?: QueryHookOptions<{ currency: TData[] }, CurrencyVars>
) {
    return useLazyQuery<{currency: TData[]}, CurrencyVars>(currencyQuery(fragment), options);
}

export function useCurrencyQuery<TData = any>(fragment: DocumentNode, options?: QueryHookOptions<{currency: TData[]}, CurrencyVars>) {
    return useQuery<{currency: TData[]}, CurrencyVars>(currencyQuery(fragment), options);
}
