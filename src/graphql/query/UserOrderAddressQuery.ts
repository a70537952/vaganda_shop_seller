...
export function useUserOrderAddressLazyQuery<TData = any>(fragment: DocumentNode, options?: QueryHookOptions<{ userOrderAddress: WithPagination<TData> }, UserOrderAddressVars>
) {
    return useLazyQuery<{userOrderAddress: WithPagination<TData>}, UserOrderAddressVars>(userOrderAddressQuery(fragment), options);
}

export function useUserOrderAddressQuery<TData = any>(fragment: DocumentNode, options?: QueryHookOptions<{userOrderAddress: WithPagination<TData>}, UserOrderAddressVars>) {
    return useQuery<{userOrderAddress: WithPagination<TData>}, UserOrderAddressVars>(userOrderAddressQuery(fragment), options);
}
