...
export function useChatClientLazyQuery<TData = any>(fragment: DocumentNode, options?: QueryHookOptions<{ chatClient: WithPagination<TData> }, ChatClientVars>
    ...
    return useLazyQuery<{chatClient: WithPagination<TData>}, ChatClientVars>(chatClientQuery(fragment), options);
}

export function useChatClientQuery<TData = any>(fragment: DocumentNode, options?: QueryHookOptions<{chatClient: WithPagination<TData>}, ChatClientVars>) {
    return useQuery<{chatClient: WithPagination<TData>}, ChatClientVars>(chatClientQuery(fragment), options);
}
