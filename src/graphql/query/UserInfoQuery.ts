...
export function useUserInfoLazyQuery<TData = any>(fragment: DocumentNode, options?: QueryHookOptions<{ userInfo: WithPagination<TData> }, UserInfoVars>
) {
    return useLazyQuery<{userInfo: WithPagination<TData>}, UserInfoVars>(userInfoQuery(fragment), options);
}

export function useUserInfoQuery<TData = any>(fragment: DocumentNode, options?: QueryHookOptions<{userInfo: WithPagination<TData>}, UserInfoVars>) {
    return useQuery<{userInfo: WithPagination<TData>}, UserInfoVars>(userInfoQuery(fragment), options);
}
