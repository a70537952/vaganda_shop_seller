...
export function useShopAddressLazyQuery<TData = any>(fragment: DocumentNode, options?: QueryHookOptions<{ shopAddress: WithPagination<TData> }, ShopAddressVars>
) {
    return useLazyQuery<{shopAddress: WithPagination<TData>}, ShopAddressVars>(shopAddressQuery(fragment), options);
}

export function useShopAddressQuery<TData = any>(fragment: DocumentNode, options?: QueryHookOptions<{shopAddress: WithPagination<TData>}, ShopAddressVars>) {
    return useQuery<{shopAddress: WithPagination<TData>}, ShopAddressVars>(shopAddressQuery(fragment), options);
}
