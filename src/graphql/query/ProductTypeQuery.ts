...
export function useProductTypeLazyQuery<TData = any>(fragment: DocumentNode, options?: QueryHookOptions<{ productType: WithPagination<TData> }, ProductTypeVars>
) {
    return useLazyQuery<{productType: WithPagination<TData>}, ProductTypeVars>(productTypeQuery(fragment), options);
}

export function useProductTypeQuery<TData = any>(fragment: DocumentNode, options?: QueryHookOptions<{productType: WithPagination<TData>}, ProductTypeVars>) {
    return useQuery<{productType: WithPagination<TData>}, ProductTypeVars>(productTypeQuery(fragment), options);
}
