...
export function useFacebookUserLazyQuery<TData = any>(fragment: DocumentNode, options?: QueryHookOptions<{ facebookUser: WithPagination<TData> }, FacebookUserVars>
) {
    return useLazyQuery<{facebookUser: WithPagination<TData>}, FacebookUserVars>(facebookUserQuery(fragment), options);
}

export function useFacebookUserQuery<TData = any>(fragment: DocumentNode, options?: QueryHookOptions<{facebookUser: WithPagination<TData>}, FacebookUserVars>) {
    return useQuery<{facebookUser: WithPagination<TData>}, FacebookUserVars>(facebookUserQuery(fragment), options);
}
