...
export function useProductImageLazyQuery<TData = any>(fragment: DocumentNode, options?: QueryHookOptions<{ productImage: TData[] }, ProductImageVars>
) {
    return useLazyQuery<{productImage: TData[]}, ProductImageVars>(productImageQuery(fragment), options);
}

export function useProductImageQuery<TData = any>(fragment: DocumentNode, options?: QueryHookOptions<{productImage: TData[]}, ProductImageVars>) {
    return useQuery<{productImage: TData[]}, ProductImageVars>(productImageQuery(fragment), options);
}
